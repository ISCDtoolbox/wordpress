...
if ( ! function_exists( 'education_base_dynamic_css' ) ) :
    ...
    function education_base_dynamic_css() {
        ...
        $custom_css .= "
              .inner-main-title {
		/*
		background: -moz-linear-gradient(top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(0, 0, 0, 0.65) 100%), url('http://hpcave.upmc.fr/wp-content/uploads/2017/09/cropped-Eliez-Universite-Jussieu-Renovation-2-2.jpg') no-repeat;
		background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(0, 0, 0, 0)), color-stop(59%, rgba(0, 0, 0, 0)), color-stop(100%, rgba(0, 0, 0, 0.65))), url('http://hpcave.upmc.fr/wp-content/uploads/2017/09/cropped-Eliez-Universite-Jussieu-Renovation-2-2.jpg') no-repeat;
		background: -webkit-linear-gradient(top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(0, 0, 0, 0.65) 100%), url('http://hpcave.upmc.fr/wp-content/uploads/2017/09/cropped-Eliez-Universite-Jussieu-Renovation-2-2.jpg') no-repeat;
		background: -o-linear-gradient(top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(0, 0, 0, 0.65) 100%), url('http://hpcave.upmc.fr/wp-content/uploads/2017/09/cropped-Eliez-Universite-Jussieu-Renovation-2-2.jpg') no-repeat;
		background: -ms-linear-gradient(top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(0, 0, 0, 0.65) 100%), url('http://hpcave.upmc.fr/wp-content/uploads/2017/09/cropped-Eliez-Universite-Jussieu-Renovation-2-2.jpg') no-repeat;
		background: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(0, 0, 0, 0.65) 100%), url('http://hpcave.upmc.fr/wp-content/uploads/2017/09/cropped-Eliez-Universite-Jussieu-Renovation-2-2.jpg') no-repeat;
		*/
